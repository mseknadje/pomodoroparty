...
export default function Party(props) {
    ...
    function joinSession(e) {
        //joinValue is an email
        //your getting the timer from someone elses session / account
        //to be insync with them
        getfbKeyWithEmail(joinValue, (id) => {
            ...
            onSnapshot(doc(db, "sessions", id), (doc) => {
                //setTestTime updates the time on your page
    ...
    function FinalTimer({ timeValue, timeHandler }) {
        ...
        return <Box >
            <Box fontSize="5xl" color={"white"} fontWeight={"bold"}>
